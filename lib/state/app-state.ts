...
const languages: Language[] = ["en", "hi", "es", "fr", "ru", "ur", "bn", "ta", "ar"];
const locales: Locale[] = ["en-IN", "en-US", "hi-IN", "es-ES", "fr-FR", "ru-RU", "ur-PK", "bn-BD", "ta-IN", "ar-SA"];
const countries: CountryCode[] = ["IN", "US", "ES", "FR", "RU", "PK", "BD", "SA", "OTHER"];
